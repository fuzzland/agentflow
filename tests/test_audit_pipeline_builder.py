...
def test_finalize_from_saved_review_publish_artifacts_snippet_executes(tmp_path: Path) -> None:
    manifest_path = tmp_path / "manifest.json"
    manifest_path.write_text(
        json.dumps(
            {
...
def test_continue_from_existing_pocs_publish_artifacts_snippet_executes(tmp_path: Path) -> None:
    manifest_path = tmp_path / "manifest.json"
    manifest_path.write_text(
        json.dumps(
            {
